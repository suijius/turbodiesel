...
class ApplicationPageEdit(TurboDieselUpdateView):
    ...
    def get(self, request, application_alias, page_alias):
        ...
        if len(page_instance) > 0:
            ...
            form.fields['template'].queryset = templates
            return self.render_to_response(self.get_context_data(form = form, request = request, page = page_instance[0], application = application, application_alias = application_alias))
