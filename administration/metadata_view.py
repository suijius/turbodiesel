...
class EntityCreate(CreateView):
    ...
    def get(self, request, application_alias):
        ...
        form = EntityForm()
        return self.render_to_response(context = self.get_context_data(form = form, request = request, application_alias = application_alias))
...
class EntityEdit(UpdateView):
    ...
    def post(self, request, application_alias, entity_alias): 
        ...
        if form.is_valid(): 
            ...
            return self.render_to_response(self.get_context_data(form = form, properties = properties, request = request, application_alias = application_alias))
...
class PropertyCreate(CreateView):
    ...
    def get(self, request, application_alias, entity_alias):
        ...
        return self.render_to_response(context = self.get_context_data(form = form, request = request, entity_alias = entity_alias, application_alias = application_alias))
    ...
    def post(self, request, application_alias, entity_alias):
        ...
        if form.is_valid(): 
            ...
            return self.render_to_response(self.get_context_data(form = form, request = request, entity_alias = entity_alias, application_alias = application_alias))
