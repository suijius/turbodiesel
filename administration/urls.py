...
urlpatterns = patterns('',
    ...
    (r'^application/(.*)/extension/ext_template/(.*)/edit/$', login_required(ExtTemplateEdit.as_view())),
    (r'^application/(.*)/extension/ext_workflow/(.*)/edit/$', login_required(ExtWorkflowEdit.as_view())),
