...
urlpatterns = patterns('',
                       ...
                       (r'^application/(.*)/extension/ext_template/create/$',
                        login_required(ExtTemplateCreate.as_view())),
                       (r'^application/(.*)/extension/ext_workflow/create/$',
                        login_required(ExtWorkflowCreate.as_view())),
                       (r'^application/(.*)/extension/ext_status/(.*)/create/$',
                        login_required(ExtStatusCreate.as_view())),
                       (r'^application/(.*)/extension/(.*)/create/(.*)/(.*)/$',
                        login_required(CustomEntityUnitCreate.as_view())),
