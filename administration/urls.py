...
urlpatterns = patterns('',
                       ...
                       (r'^application/(.*)/extension/exttemplate/(.*)/edit/$', login_required(ExtTemplateEdit.as_view())),
                       ...
                       (r'^application/(.*)/extension/exttemplate/create/$', login_required(ExtTemplateCreate.as_view())),
