...
urlpatterns = patterns('',
    ...
    (r'^apply_filter_from_xls/$', 'turbodiesel.core.portal.apply_filter_from_xls'), #Применение фильтров для импорта в xls
    ...
    (r'^request_entity_value_table/(\d*)/(\d*)/(.*)$', 'turbodiesel.core.views.request_table_content'),
    ...
    (r'^request_entity_control/(\d*)/(.*)/(.*)/$', 'turbodiesel.core.views.get_properties_from_entity_control'),
