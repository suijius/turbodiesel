    ...
    $.fn.graphTable = function (_graphArgs, _flotArgs) {
        ...
        return $(this).each(function () {
            ...
            switch (args.series) {
                case 'rows':
                    ...
                    for (i = args.firstseries; i <= args.lastseries; i++) {
                        ...
                        if (args.labelTransform) {
                            label = args.labelTransform(label);
                        }
                        ...
                        for (j = args.dataStart; j <= args.dataEnd; j++) {
                            ...
                            if (args.dataTransform) {
                                y = args.dataTransform(y);
                            }
                            if (args.xaxisTransform) {
                                x = args.xaxisTransform(x);
                            }
            ...
            switch (args.position) {
                case 'after':
                    $div = $('<div class="chart_flot" />').insertAfter($table);
                    break;
                ...
                default:
                    $div = $('<div class="chart_flot" />').insertBefore($table);
                    break;
            }
