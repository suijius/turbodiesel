    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                grid: {
                    show: true,
                    aboveData: false,
                    color: "#6b6969", // primary color used for outline and labels
        ...
        function parseOptions(opts) {
            ...
            if (options.grid.tickColor == null)
                options.grid.tickColor = $.color.parse(options.grid.color).scale('a', 0.85).toString();
