...
(function (b) {
    var a = {init: function (c) {
        return this.each(function () {
            var g = b.extend({}, b.fn.stepy.defaults, c), m = b(this).data("options", g), f = m.attr("id");
            if (f === undefined || f == "") {
                f = "stepy-" + b("." + m.attr("class")).index(this);
                m.attr("id", f);
            }
            var p = b("<ul/>", {id: f + "-titles", "class": "stepy-titles"});
            if (g.titleTarget) {
            ...
            if (g.validate) {
                jQuery.validator.setDefaults({ignore: g.ignore});
                m.append('<div class="stepy-error"/>');
            }
            var l = m.children("fieldset"), e = undefined, i = undefined, o = "", n = "";
            l.each(function (q) {
                e = b(this);
            ...
            if (g.titleClick) {
                d.click(function () {
                    var s = d.filter(".current-step").attr("id").split("-"), r = parseInt(s[s.length - 1], 10), q = b(this).index();
                    if (q > r) {
            ...
            l.delegate('input[type="text"], input[type="password"]', "keypress", function (r) {
                ...
                if (t == 13) {
                    ...
                    if (s.length) {
                        var q = s.children(".btn btn-primary");
                        if (q.length) {
                            q.click();
                        } else {
        ...
        var e = this, f = this.attr("id"), d = this.data("options");
        b("<a/>", {id: f + "-back-" + c, href: "javascript:void(0);", "class": "btn btn-primary", html: d.backLabel}).click(function () {
        ...
        var e = this, f = this.attr("id"), d = this.data("options");
        b("<a/>", {id: f + "-next-" + c, href: "javascript:void(0);", "class": "btn btn-primary right", html: d.nextLabel}).click(function () {
        ...
        var c = this.children("fieldset").eq(d), h = true, f = b("#" + this.attr("id") + "-titles").children().eq(d), e = this.data("options"), g = this.validate();
    ...
    b.fn.stepy.defaults = {back: undefined, backLabel: "Back", block: false, description: true, errorImage: false, finish: undefined, finishButton: true, legend: true, ignore: "", next: undefined, nextLabel: "Next", titleClick: false, titleTarget: undefined, validate: false, select: undefined};
})(jQuery);